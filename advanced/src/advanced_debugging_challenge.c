...
- manually compile and run your code 
    - compiler many times with multiple options (as described in lecture in this section)
...
Challenge 2)
- will need to use the preprocessor directives to debug
- will need to use gdb
- will need to use gdb to analyze a core file
*/
